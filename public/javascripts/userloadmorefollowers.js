...
let limit = 10;
let loading = false;
const API_URL = window.location.hostname.includes("dev") ? `https://www.post67.com.dev/api/users/${userid}/followers` : `https://www.post67.com/api/users/${userid}/followers`;
